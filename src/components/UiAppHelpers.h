...
// Defined once in ListIcons.cpp: the icon bitmaps are static tables, and an
// inline definition here duplicated every table in each translation unit that
// called it (about 4 KB per copy on the C3 image).
freeink::ui::BitmapRef listIconFor(UIIcon icon, int size = 24);

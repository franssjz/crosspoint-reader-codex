...
MappedInputManager::Labels MappedInputManager::mapLabels(const char* back, const char* confirm, const char* previous,
  ...
  // Fork: normalise "« Back"-style prefixes into a plain "<< " marker.
  thread_local std::string sanitizedBack;
  sanitizedBack = sanitizeBackLabel(back);
  return mapFrontLabels(sanitizedBack.c_str(), confirm, leftLabel, rightLabel);
}

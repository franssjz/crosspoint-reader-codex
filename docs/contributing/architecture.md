...
```mermaid
graph TD
    A[Hardware: ESP32-C3 X4/X3 or ESP32-S3 X4 Pro + SD + E-ink + Buttons/Touch] --> B[freeink-sdk]
...
- `freeink-sdk/`: hardware SDK submodule (board profiles, panel detection, display, touch, frontlight, input, storage, battery and power). Docs: https://freeink.org/docs
